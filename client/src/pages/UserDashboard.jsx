          ...
          {myListings.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {myListings.map((p) => (
                <div
                  key={p._id}
                  className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-xs flex flex-col group transition-all"
                >
                  <div className="relative aspect-[16/9] bg-slate-100 dark:bg-slate-800 overflow-hidden">
                    <Link to={`/products/${p._id}`} className="block w-full h-full cursor-pointer">
                      <img
                    ...
                    <span
                      className={`absolute top-3 left-3 text-[10px] font-bold px-2.5 py-1 rounded-md uppercase tracking-wider pointer-events-none ${
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    <Link to={`/products/${p._id}`} className="block">
                      <h3 className="font-bold text-slate-900 dark:text-white text-sm line-clamp-1 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                        {p.title}
                      </h3>
                    </Link>
                    ...
                    {p.status === "REJECTED" && p.rejectionReason && (
                      <div className="mt-2 p-2 bg-rose-50 dark:bg-rose-950/40 text-rose-700 dark:text-rose-300 text-xs rounded-xl border border-rose-200 dark:border-rose-800">
                    ...
                    <div className="mt-auto pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2 flex-wrap">
                      ...
                      {p.status !== "SOLD" && (
                        <button
                          ...
                          className="px-2.5 py-1.5 text-xs font-semibold text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/40 hover:bg-emerald-100 dark:hover:bg-emerald-900/40 rounded-xl"
                        >
                          Mark Sold
                        </button>
                      )}
                      ...
                      {p.status === "SOLD" && (
                        <button
                          ...
                          className="px-2.5 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-xl"
                        >
                          Relist Item
                        </button>
                      )}
                      ...
                      <button
                        ...
                        className="p-2 text-rose-500 hover:text-rose-700 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 rounded-xl ml-auto"
