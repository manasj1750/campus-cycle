          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-lg lg:max-w-none">
                ...
                {/* Free Space Status Row Above Card */}
                <div className="mb-3.5 flex items-center justify-between gap-2.5">
                  <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200/80 dark:border-emerald-800 text-emerald-800 dark:text-emerald-300 text-xs font-bold shadow-2xs">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
                    <span>Safe Campus Exchange</span>
                  </div>

                  {/* Live Campus Deals Badge - Free Space Top Right Corner */}
                  <div className="inline-flex items-center gap-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl px-3.5 py-1.5 shadow-md border border-slate-200/90 dark:border-slate-800">
                ...
                {/* Free Space Micro Info Below Card */}
                <div className="mt-3 flex items-center justify-between px-2 text-xs text-slate-500 dark:text-slate-400 font-medium">
                  <span className="flex items-center gap-1.5">
                    <TrendingDown className="w-3.5 h-3.5 text-amber-500" />
                    <span>Student Savings: <strong className="text-slate-900 dark:text-white font-bold">₹{stats.estimatedSavings.toLocaleString("en-IN")}+</strong></span>
                  </span>
